...
<div class="row">
  <div class="col-lg-12">
    <img class="homepageimg" src="images/register.jpg" alt="register page image">
    <img class="register_logo" src="images/register.png" alt="register word">
  </div>
</div>


<div class="container my_register">
  <div class="row">
    <div class="col-xs-12">  
